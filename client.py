...
def askPlayerName():
    ...
    canvas1.create_text( screen_width/2, screen_height/5, text = "Enter nickname", font=("Chalkboard SE",100), fill="yellow")

    nameEntry = Entry(nameWindow, width=15, justify='center', font=('Chalkboard SE', 50), bd=5, bg='yellow')
